...
::: panel-tabset
### [**Tejupilco de Hidalgo**]{style="color:#990000"}
...
::: wrapper
::: {.box .a}
```{r hotspots_dengue_tejupilco}
loc <- rgeomex::extract_locality(cve_edo = "15", 
...
::: {.box .b}
```{r forest_plot_tejupilco, dpi = 300, fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_tejupilco,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
...
::: {.box .d}
```{r gauge_blocks_tejupilco,fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
...
::: {.box .e}
```{r gauge_AGEB_tejupilco, fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .f}
```{r gauge_tejupilco, out.height='90%', out.width = '90%', fig.align = "center"}
...
### [**Tejupilco de Hidalgo**]{style="color:#990000"}
```{r vector_tejupilco, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_15_estado_de_mexico,
                           locality = "Tejupilco de Hidalgo",
                           cve_edo = "15",
...
### [**Santo Tomas de los Platanos**]{style="color:#990000"}
```{r vector_santo_tomas, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_15_estado_de_mexico,
                           locality = "Santo Tomas de los Platanos",
                           cve_edo = "15",
                           palette = rcartocolor::carto_pal,
                           name = "SunsetDark",
                           static_map = FALSE)
